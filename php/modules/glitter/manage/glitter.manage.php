...
_::ajax()->register(array('digglitter','delglitter','addtab'),'manage');
...
if($count=$db->count('glitter',$arg))
{
	...
	$glitter=$db->find('glitter',$arg,array('_id'=>1,'t'=>1,'fd'=>1,'c'=>1,'ty'=>1,'zp'=>1,'da'=>1),array('skip'=>$skip,'limit'=>44,'sort'=>array('_id'=>-1)));
}

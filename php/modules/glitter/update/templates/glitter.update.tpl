...
<div class="controls">
<textarea id="input09" style="height:60px;" class="span7" name="detail" maxlength="1000" minlength="10" required><?php echo $this->glitter['t']?></textarea>
...
<div class="controls">
<img src="http://s3.boxza.com/glitter/<?php echo $this->glitter['fd']?>/l.<?php echo $this->glitter['ty']?><?php echo $_SERVER['QUERY_STRING']=='updated'?'?'.rand(1,999):''?>">

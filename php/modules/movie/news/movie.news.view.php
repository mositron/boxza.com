...
_::$meta['title']=$news['t'].' - '.implode(' ',$ctitle).' หนังใหม่ วิจารณ์หนัง หนังเข้าใหม่ ข่าวหนังวันนี้ ข่าวหนังล่าสุด';
_::$meta['description']=$news['t'].' - '.implode(' ',$ctitle).' หนังใหม่ วิจารณ์หนัง ตัวอย่างหนัง หนังเข้าใหม่ ข่าวหนังวันนี้ ข่าวหนังล่าสุด';
_::$meta['keywords']=implode(', ',$ctitle).', หนังใหม่, ดูหนังออนไลน์, ตัวอย่างหนัง, ดูหนังใหม่';

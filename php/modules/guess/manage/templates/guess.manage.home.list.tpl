...
<?php foreach($this->allorder as $key=>$val):?>
<?php if($key=='p'):?>
<td width="60" class="tab_<?php echo $key?>"><?php if($this->app[$i]['img']):?><img src="http://s3.boxza.com/guess/<?php echo $this->app[$i]['fd']?>/s.jpg" style="width:60px"><?php endif?></td>
<?php elseif($key=='s'):?>
...
<?php if($this->app[$i]['pl']):?>
<br><a href="http://guess.boxza.com/game/<?php echo $this->app[$i]['_id']?>" target="_blank">http://guess.boxza.com/game/<?php echo $this->app[$i]['_id']?></a>
<?php endif?>

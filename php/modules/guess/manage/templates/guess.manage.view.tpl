<style type="text/css">
.table .span12{margin-bottom:2px;}
...
<li><a href="/manage/new"<?php if(_::$path[0]=='new'):?> class="active"<?php endif?>><i class="icon-plus"></i> สร้างเกมใหม่</a></li>
...
<tr><td class="colum">ชื่อเกม <small>:</small></td><td valign='top'><input type="text" class="span12" name="title" value="<?php echo $this->app['t']?>" maxlength="50" required><br><span class="req">*</span> สูงสุดไม่เกิน 50 ตัวอักษร</td></tr>
<tr><td class="colum">รูปภาพประกอบ <small>:</small></td><td valign='top'>
<div><img src="<?php if($this->app['img']):?>http://s3.boxza.com/guess/<?php echo $this->app['fd']?>/s.jpg<?php endif?>" class="prv-img"></div>
<input type="file" name="photo" id="photo"<?php echo _::$path[0]=='new'?' required':''?>> <br>*  ขนาดภาพประมาณ 200x200 (ระบบย่อและ crop ให้อัตโนมัติ)
</td></tr>
...
<tr><td class="colum">คำอธิบายของเกม <small>:</small></td><td valign='top'><textarea name="detail" class="span12" style="height:100px" required><?php echo $this->app['d']?></textarea><br><span class="req">*</span> สูงสุดไม่เกิน 150 ตัวอักษร, ใช้สำหรับโฆษณาให้ผู้อื่นมาเล่น</td></tr>
...
<tr><td class="r">ชื่อผลลัพธ์</td><td><input type="text" name="ans_t[]" class="span12 inp_ans" value="<?php echo $this->app['ans'][$i]['t']?>" onBlur="calans()" required></td></tr>
<tr><td class="r">คำอธิบายผลลัพธ์</td><td><textarea name="ans_d[]" class="span12" style="height:70px" required><?php echo $this->app['ans'][$i]['d']?></textarea></td></tr>
<tr><td class="r">รูปภาพประกอบ</td><td><?php if($this->app['ans'][$i]['i']):?><img src="http://s3.boxza.com/guess/<?php echo $this->app['fd']?>/<?php echo $this->app['ans'][$i]['i']?>" style="max-height:100px; max-width:100px"><br><?php endif?><input type="file" name="ans_i[]"><br>ปล่อยว่างได้: ขนาดภาพประมาณ 200x200 (ระบบย่อและ crop ให้อัตโนมัติ)</td></tr>
...
<tr><td class="r">ชื่อผลลัพธ์</td><td><input type="text" name="ans_t[]" class="span12 inp_ans" value="" onBlur="calans()" required></td></tr>
<tr><td class="r">คำอธิบายผลลัพธ์</td><td><textarea name="ans_d[]" class="span12" style="height:70px" required></textarea></td></tr>
...
<?php if($i>=2):?><tr><td class="r"></td><td><a href="javascript:;" class="btn btn-mini" onClick="delans(this)"><i class="icon-trash"></i> ลบคำตอบนี้</a></td></tr><?php endif?>
</tbody>
</table>
<?php endif?>
<?php endfor?>
</div>
<div style="padding:4px; background:#f0f0f0;"><a href="javascript:;" class="btn btn-warning" onClick="addans()"><i class="icon-plus icon-white"></i> เพิ่มคำตอบใหม่</a></div>
</td></tr>
...
<tr class="q"><td class="r">คำถาม</td><td><input type="text" name="quest_t[]" class="span12" value="<?php echo $this->app['quest'][$i]['t']?>" required></td></tr>
<?php for($j=0;$j<$ans;$j++):?>
<tr class="a"><td class="r">คำตอบที่ <span class="qans_no"><?php echo $j+1?></span></td><td><input type="text" name="quest_a[]" class="span12" value="<?php echo $this->app['quest'][$i]['a']&&$this->app['quest'][$i]['a'][$j]?$this->app['quest'][$i]['a'][$j]['t']:''?>" required><div class="ans_v"></div></td></tr>
<?php endfor?>
<tr class="r"><td class="r"></td><td><a href="javascript:;" class="btn btn-mini" onClick="delquest(this)"><i class="icon-trash"></i> ลบคำถามนี้</a> - หมายเหตุ: ระบบจะสลับคำถาม และสลับคำตอบให้อัตโนมัติ</td></tr>
</tbody>
</table>
<?php else:?>
<table width="100%" class="table table-condensed">
...
<tr class="q"><td class="r">คำถาม</td><td><input type="text" name="quest_t[]" class="span12" value="" required></td></tr>
<?php for($j=0;$j<$ans;$j++):?>
<tr class="a"><td class="r">คำตอบที่ <span class="qans_no"><?php echo $j+1?></span></td><td><input type="text" name="quest_a[]" class="span12" value="" required><div class="ans_v"></div></td></tr>
<?php endfor?>
<tr class="r"><td class="r"></td><td><a href="javascript:;" class="btn btn-mini" onClick="delquest(this)"><i class="icon-trash"></i> ลบคำถามนี้</a> - หมายเหตุ: ระบบจะสลับคำถาม และสลับคำตอบให้อัตโนมัติ</td></tr>
</tbody>
</table>
...
<div style="padding:4px; background:#f0f0f0;"><a href="javascript:;" class="btn btn-warning" onClick="addquest()"><i class="icon-plus icon-white"></i> เพิ่มคำถามใหม่</a></div>
</td></tr>
<?php if(_::$my['am']>=9):?>
...
<tr><td class="colum"></td><td valign='top'><input type="submit" class="btn btn-info" value="          บันทึก          ">  หรือกลับไปยัง <a href="/manage" class="btn btn-mini">เกมส์ของฉัน</a></td></tr>
</table>
</form>
...
'<tr><td class="r">คำอธิบายผลลัพธ์</td><td><textarea name="ans_d[]" class="span12" style="height:70px" required></textarea></td></tr>'+
'<tr><td class="r">รูปภาพประกอบ</td><td><input type="file" name="ans_i[]"><br>ปล่อยว่างได้: ขนาดภาพประมาณ 200x200 (ระบบย่อและ crop ให้อัตโนมัติ)</td></tr>'+
'<tr><td class="r"></td><td><a href="javascript:;" class="btn btn-mini" onClick="delans(this)"><i class="icon-trash"></i> ลบคำตอบนี้</a></td></tr>'+
'</tbody>'+
'</table>');	
	$('.ans_no').each(function(index, element) {
        $(this).html(index+1);
...
'<tr class="q"><td class="r">คำถาม</td><td><input type="text" name="quest_t[]" class="span12" value="" required></td></tr>';
	...
	for(var j=0;j<c;j++)
	{
		tmp+='<tr class="a"><td class="r">คำตอบที่ <span class="qans_no"></span></td><td><input type="text" name="quest_a[]" class="span12" value="" required><div class="ans_v"></div></td></tr>';
	}
	tmp+='<tr class="r"><td class="r"></td><td><a href="javascript:;" class="btn btn-mini" onClick="delquest(this)"><i class="icon-trash"></i> ลบคำถามนี้</a> - หมายเหตุ: ระบบจะสลับคำถาม และสลับคำตอบให้อัตโนมัติ</td></tr>'+
'</tbody>'+
'</table>';
...
function calans()
{
	...
	$('#app_question > table').each(function(index, element) {
		...
		else if(a.length>q.length)
		{
			...
			{
				w.before('<tr class="a"><td class="r">คำตอบที่ <span class="qans_no"></span></td><td><input type="text" name="quest_a[]" class="span12" value="" required><div class="ans_v"></div></td></tr>');
			}
		}

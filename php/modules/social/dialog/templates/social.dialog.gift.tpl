...
<form onSubmit="_.ajax.gourl('/<?php echo $this->user['link']?>','sendgift',this);_.box.close();return false;">
<div class="gbox_header">มอบของขวัญให้ <?php echo $this->user['name']?></div>
<div class="gbox_content" style="text-align:center;">
<?php if($this->user && $this->user['_id']!=_::$my['_id']):?>
...
if(is_array($v['u'])&&!in_array(_::$my['_id'],$v['u']))continue;
?>
<li>
<label>
<h5><?php echo $v['n']?></h5>
<img src="http://s1.boxza.com/gift/64/<?php echo $k?>.png">
<div>
...
<div style="text-align:center; padding:5px; text-align:center; background:#f0f0f0; margin:10px 10px 0px">คุณมี  <?php echo intval(_::$my['cd']['p'])?> บ๊อก</div>
</div>
<?php else:?>

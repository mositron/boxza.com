...
<meta name="google-site-verification" content="bS_jp7dO8HnZfsqN-_YsvrFlumIwn-S8G4xtl-KXXrk" />
<meta name="alexaVerifyID" content="FOoo4j7nVRCrXHY0CW2oBbJNQ3I" />
...
<meta property="profile:first_name" content="<?php echo _::$profile['if']['fn']?>">
<meta property="profile:last_name" content="<?php echo _::$profile['if']['ln']?>">
<meta property="profile:username" content="<?php echo _::$profile['link']?>">
<meta property="profile:gender" content="<?php $gd=array('m'=>'male','f'=>'female','u'=>'');echo $gd[_::$profile['if']['gd']]?>">
<?php endif?>
...
<?php else:?>
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/boxza.css">
<?php endif?>
<?php if(_::$meta['profile']):?>
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/js/jquery/ui/jquery-ui-1.10.1.custom.min.css">
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/boxza.line.css?v=<?php echo VERSION?>">
<?php endif?>
...
<script type="text/javascript" src="http://s0.boxza.com/static/js/boxza.js?v=<?php echo VERSION?>"></script>
<?php if(_::$meta['bootstrap']):?>
...
<script type="text/javascript" src="http://s0.boxza.com/static/js/boxza.line.js?v=<?php echo VERSION?>"></script>
<script type="text/javascript" src="http://boxza.com/_static/js/tiny_mce/tiny_mce.js"></script>
<?php endif?>

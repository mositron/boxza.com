...
_::$meta['title']=$news['t'].' - '.implode(' ',$ctitle).' ดูดวงวันนี้ ดูดวงล่าสุด ดูดวงชะตา ดูดวงแม่น';
_::$meta['description']=$news['t'].' - '.implode(' ',$ctitle).' หมอดู ดูดวงวันนี้ ดูดวงล่าสุด ดูดวงชะตา ดูดวงแม่น';
_::$meta['keywords']=implode(', ',$ctitle).', ดูดวงวันนี้, ดูดวงล่าสุด, ดูดวงชะตา, ดูดวงแม่น, ทำนายดวง';

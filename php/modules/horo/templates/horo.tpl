...
<meta property="og:site_name" content="ดูดวง">
...
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/horo.css">
...
$(function(){
	$('.horo-no').on('mouseup keyup',calhoro);
	$('.horo-sel').on('change blur',calhoro);
});
function goluckysim(a)
{
	window.open('http://www.luckysim.com/search.php?title='+a.substr(0,3)+'&n='+a.substr(3,1)+'&n2='+a.substr(4,1)+'&n3='+a.substr(5,1)+'&n4='+a.substr(6,1)+'&n5='+a.substr(7,1)+'&n6='+a.substr(8,1)+'&n7='+a.substr(9,1)+'','_blank');
}
function calhoro()
{
	var v=$('.horo-sel').val(),j,s='0123456789',r=0;
	...
	{
		r+=parseInt(v.substr(i,1));
	}
	$('.horo-rs').html(r);
}
function horoshow()
{
	var v=parseInt($('.horo-rs').html());
	if(v<11 || v>100){
	...
	{
		window.location.href='/phone/'+v+'.html';
	}
}
</script>

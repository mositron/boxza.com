...
<li class="span3">
<a href="/v/<?php echo $this->image[$i]['f'].'.'.$this->image[$i]['ty']?>" target="_blank"><img src="http://i.boxza.com/<?php echo $this->image[$i]['fd'].'/s.'.$this->image[$i]['ty']?>" class="i"></a>
<div class="c">
<a href="javascript:;" onClick="_.box.load('/report/<?php echo $this->image[$i]['_id']?> #report')"><i class="icon-trash"></i> แจ้งลบ/ลบ</a>
</div>
</li>
<?php endfor?>
</ul>

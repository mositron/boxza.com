...
<div style="padding:5px; border:1px solid #f0f0f0; text-align:center;"><a href="http://image.boxza.com/" target="_blank">image.boxza.com</a> - เว็บฝากรูปภาพฟรี ให้คุณฝากรูปฟรีสูงสุด <strong>10MB</strong> ต่อรูปฟรี!! ไม่มีวันหมดอายุ</div>
<?php if($this->error):?>

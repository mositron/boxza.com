...
<link href="http://s0.boxza.com/static/css/image.css" rel="stylesheet" type="text/css">
</head>
<body>
...
IP: <?php echo $this->image['ip']?> - เวลาโพส: <?php echo time::show($this->image['da'],'datetime')?>
</div>

<?php if(_::$my && ((_::$my['_id']==$this->image['u'])||(_::$my['am'] &&_::$my['am']>0))):?>

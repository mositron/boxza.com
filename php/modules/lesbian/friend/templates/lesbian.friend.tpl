...
<iframe frameborder="0" width="100%" height="500" src="http://s0.boxza.com/static/chat/?f=0&r=3&radio=0"></iframe>
...
<div class="fb-like-box" data-href="https://www.facebook.com/BoxzaNetwork" data-width="295" data-height="255" data-show-faces="true" data-stream="false" data-header="false" data-show-border="false" style="width:295px;overflow:hidden;"></div>
</div>
...
<select name="province" class="span2" style="width:267px" required>
<option value="">กรุณาเลือก</option>
...
<div class="input-prepend input-append"><span class="add-on">facebook.com/</span><input type="text" class="span2" name="facebook" style="width:118px;" readonly><input type="hidden" name="facebook_id" id="facebook_id"><input type="hidden" name="facebook_name" id="facebook_name"><button class="btn" type="button" onClick="addfb()">เพิ่ม!</button></div>
</td>
</tr>
<tr><td colspan="2">
<strong>BoxZa</strong>
<div class="input-prepend input-append"><span class="add-on">boxza.com/</span><input type="text" class="span2" name="inettown" style="width:137px;" readonly><button class="btn" type="button" onClick="addin()">เพิ่ม!</button></div>
</td></tr>
<tr><td colspan="2">
<strong>Line</strong>
<input type="text" class="span2" name="line" style="width:257px;">
</td></tr>
<tr><td colspan="2">
<strong>Twitter</strong>
<div class="input-prepend"><span class="add-on">@</span><input type="text" class="span2" name="twitter" style="width:230px"></div>
</td></tr>
<tr><td colspan="2">
...
<div class="zone-box">
<h3 class="hz"><i></i> หาเพื่อนเลสเบี้ยนตามจังหวัด หาเพื่อนเลสเบี้ยนตามภูมิภาค</h3>
<ul class="nav-zone thumbnails row-count-6">
<?php foreach($this->pc as $k=>$n):?>
<li class="span2">
<h4><a href="/friend/z-<?php echo $k?>" title="หาเพื่อนเลสเบี้ยน <?php echo $this->zone[$k]['n']?>"><i class="icon-map-marker"></i><?php echo $this->zone[$k]['n']?></a></h4>
<ul>
<?php 
foreach($n as $v):?>
<li><a href="/friend/p-<?php echo $v['_id']?>"><?php echo $v['t']?></a></li>
<?php endforeach?>
<li><a href="/friend/z-<?php echo $k?>" title="หาเพื่อนเลสเบี้ยน<?php echo $this->zone[$k]['n']?> ทั้งหมด">ทั้งหมด</a></li>
</ul>
</li>
<?php endforeach?>
</ul>
...
<div>
<h3 class="hn"><i></i> เพื่อนเลสเบี้ยนมาใหม่</h3>
<ul class="breadcrumb">
<li><a href="/" title="เลสเบี้ยน ทอมดี้"><i class="icon-home"></i> เลสเบี้ยน</a></li>
<span class="divider">&raquo;</span>
<li><a href="/friend" title="หาเพื่อนเลสเบี้ยน"><i class="icon-list"></i> หาเพื่อนเลสเบี้ยน</a></li>
<span class="divider">&raquo;</span>
 <li class="dropdown">

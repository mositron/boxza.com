...
<link href="http://s0.boxza.com/static/css/friend.css" rel="stylesheet" type="text/css">
</head>
<body>
...
IP: <?php echo $this->friend['ip']?> - เวลาโพส: <?php echo time::show($this->friend['da'],'datetime')?>
</div>


<?php if(_::$my && ((_::$my['_id']==$this->friend['u'])||(_::$my['am'] &&_::$my['am']>0))):?>
...
<?php if(_::$my['am']&&$this->friend['fd']&&$this->friend['pt']):?> <input type="button" class="button" value=" ตั้งเป็นเพื่อนแนะนำ " onClick="_.ajax.gourl('/friend','setrec',<?php echo $this->friend['_id']?>);_.box.close()"> <?php endif?>

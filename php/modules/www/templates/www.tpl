...
<meta property="og:site_name" content="BoxZa">
...
<?php if(MODULE=='home'):?>
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/www.home.css">
<?php elseif(MODULE=='home2'):?>
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/www.home2.css">
<?php endif?>
...
echo '<style>.banner-a embed,.banner-a object{max-width:100%;}';
if(preg_match('/iPhone|iPod|iPad|BlackBerry|Android/',$_SERVER['HTTP_USER_AGENT'])):
	echo '.banner-a{display:none;}';
endif;
echo '</style>';
?>
</body>

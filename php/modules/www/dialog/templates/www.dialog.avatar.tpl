...
<div id="avatar_thumb" class="gbox" style="width:680px; min-height:400px" onclose="_.hash.close()" onopen="_.profile.img.av.thumb('<?php echo $this->picture?>',<?php echo $this->w?>,<?php echo $this->h?>)">
...
<div>
   ...
   <div align="center" style="display:none" id="showsave">
       <form onSubmit="_.ajax.gourl('/user/<?php echo _::$my['link']?>','savecrop',this);return false">

<div id="upload_header" class="gbox" style="width:400px" onopen="_.profile.img.up()">
...
<div id="upload_avatar" class="gbox" style="width:400px" onopen="_.profile.img.up()">
<form onSubmit="return false;">
<div class="gbox_header">เปลี่ยนรูปภาพ</div>
<div class="gbox_content" style="text-align:left">
<table cellpadding="5" cellspacing="1" border="0" width="100%" class="tbservice">
...
<form action="/user/<?php echo _::$my['link']?>" method="post" enctype="multipart/form-data" onSubmit="_.box.close()">
...
<?php $pos=array('left top'=>'ซ้าย บน','left center'=>'ซ้าย กลาง','left bottom'=>'ซ้าย ล่าง','center top'=>'กลาง บน','center center'=>'กลาง กลาง','center bottom'=>'กลาง ล่าง','right top'=>'ขวา บน','right center'=>'ขวา กลาง','right bottom'=>'ขวาล่าง')?>
...
<?php $repeat=array('no-repeat'=>'ไม่ทำซ้ำ','repeat-x'=>'ซ้ำเฉพาะแนวนอน','repeat-y'=>'ซ้ำเฉพาะแนวตั้ง','repeat'=>'ซ้ำทั้งหมด')?>

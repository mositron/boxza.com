...
if(!_::$content=$cache->get('ca1','home'))
{
	...
	{
		$news[$i]=$db->find('news',array('c'=>intval($i),'pl'=>1,'dd'=>array('$exists'=>false)),array('_id'=>1,'t'=>1,'fd'=>1,'da'=>1,'c'=>1,'cs'=>1,'url'=>1),array('sort'=>array('_id'=>-1),'limit'=>11));
	}
	...
	$ent['inter']=$db->find('news',array('pl'=>1,'dd'=>array('$exists'=>false),'c'=>4,'cs'=>array('$in'=>array(4,5))),array('_id'=>1,'t'=>1,'fd'=>1,'da'=>1,'c'=>1,'cs'=>1,'exl'=>1,'url'=>1),array('sort'=>array('_id'=>-1),'limit'=>3));
	...
	$tags=array();
	$tmp=$db->find('tags',array('amount'=>array('$gte'=>3)),array(),array('sort'=>array('amount'=>-1,'du'=>-1),'limit'=>15),false);
	...
	$template->assign('news',(array)$news);

...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="<?php echo $this->province['n']?>"><?php echo $this->province['n']?></a></h1>
        <h2>สถานที่ใน<?php echo $this->province['n']?> ร้านอาหาร ห้างสรรพสินค้า ร้านค้า โรงเรียน สถานศึกษา </h2>
        <!-- BEGIN - BANNER : A -->
        ...
        <nav class="navbar hbar">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a class="brand" href="/" title="สถานที่ในจังหวัด<?php echo $this->province['n']?> โรงแรม ร้านอาหาร ห้างสรรพสินค้า โรงพยาบาล ปั๊มน้ำมัน"><?php echo $this->province['n']?></a>

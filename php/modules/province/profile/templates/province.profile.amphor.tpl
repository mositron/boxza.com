...
<span class="divider">&raquo;</span>
<li><a href="<?php echo $curlink=('/'.$this->place['tt']['t2']['lk'].'/'.$this->place['lk'])?>" title="<?php echo $this->place['n']?>  จังหวัด<?php echo $this->place['tt']['t2']['n']?>"><?php echo $this->place['n']?></a></li>
</ul>
...
<?php endif?>
<!-- END - BANNER : B -->
<h3><?php echo $this->place['n']?> <small><?php echo $this->place['q']?> <?php echo ($this->isbkk?'':'จังหวัด').$this->place['tt']['t2']['n']?> <?php echo $this->place['tt']['t1']['n']?> <?php if(_::$my['am']):?> (<a href="/admin/<?php echo $this->place['_id']?>">แก้ไข</a>)<?php endif?></small></h3>

...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="แต่งงาน">แต่งงาน</a></h1>
        <h2>แต่งงาน ฤกษ์แต่งงาน ชุดแต่งงาน ชุดเจ้าสาว ชุดเจ้าบ่าว เพลงแต่งงาน ของชำร่วย</h2>
        <!-- BEGIN - BANNER : A -->
		...
		<nav class="navbar navbar-inverse hbar">
            <div class="navbar-inner">
                <div class="container"> 
                    ...
                    <a class="brand" href="/" title="แต่งงาน">แต่งงาน</a>

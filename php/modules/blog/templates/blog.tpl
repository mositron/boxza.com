...
<meta property="og:site_name" content="ข่าวเด่น ข่าวบันเทิง">
...
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/news.css">
...
<?php if(MODULE=='home'):?>
<script type="text/javascript" src="http://s0.boxza.com/static/js/cufon-yui.js"></script>
<script type="text/javascript" src="http://s0.boxza.com/static/js/supermarket_400.font.js"></script>
<script type="text/javascript">$(function(){Cufon.replace('.cufon');})</script>
<?php endif?>

...
<!--div id="sub-bar">
  <div id="social">
    <iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FBoxzaNetwork&amp;send=false&amp;layout=button_count&amp;width=150&amp;show_faces=true&amp;font&amp;action=like&amp;height=21&amp;appId=124335767713181" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:58px; height:21px;" allowtransparency="true"></iframe>
...
var m={
	...
	open:function()
	{
		...
		{
			tmp+='<div onclick="m.opencard('+i+');"><p><img src="http://s0.boxza.com/static/images/mobile/matching/'+m.game.icon+'/'+m.card[i]+'.png"></p><div id="cell_'+i+'"></div></div>';
		}

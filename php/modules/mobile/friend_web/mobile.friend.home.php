...
_::ajax()->register(array('newfriend','delms','setuser'));
...
{
	$ajax=_::ajax();	
	$user=base64_encode(json_encode(array('id'=>$arg['id'],'name'=>$arg['name'])));
	setcookie('fb',$user,time()+2592000,'/friend','mobile.boxza.com',false,true);
}
?>

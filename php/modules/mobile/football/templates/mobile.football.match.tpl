...
<p>เวลา: <?php echo time::show($this->match['tm'],'datetime')?></p>
</div>
...
<tbody>
<tr>
<td class="i1"><img src="http://s3.boxza.com/football/team/<?php echo $this->team1['fd']?>/o.png" alt="<?php echo $this->team1['n']?>"></td>
<td><?php if($this->match['ft']):?><?php echo $this->match['ft']?><?php endif?></td>
<td class="i2"><img src="http://s3.boxza.com/football/team/<?php echo $this->team2['fd']?>/o.png" alt="<?php echo $this->team2['n']?>"></td>
</tr>
</tbody>
</table>
</div>
...
<tbody>
<?php $i=0;$py=array('1'=>array(),'2'=>array(),'i1'=>array(),'i2'=>array(),'o1'=>array(),'o2'=>array());foreach($this->match['ki'] as $v):?>
<tr class="l<?php echo $i%2?>">
...
<td class="i"><i><img src="http://s3.boxza.com/football/team/<?php echo $this->_team[$ot]['fd']?>/s.png" alt="<?php echo $this->_team[$ot]['f']?>"></i></td>
...
<td class="i"><i><img src="http://s3.boxza.com/football/team/<?php echo $this->_team[$v['t']['_id']]['fd']?>/s.png" alt="<?php echo $this->_team[$v['t']['_id']]['f']?>"></i></td>

...
<h1 class="news-h1"><img src="http://s0.boxza.com/static/images/football/forum/<?php echo $this->news['c']?>.png" style="vertical-align:middle"> <?php echo $this->news['t']?></h1>
...
<img src="http://s3.boxza.com/forum/<?php echo $this->news['fd']?>/<?php echo $v?>">
</p>
<?php endif?>
<?php endforeach?>
</div>

...
$pp=50;
extract(_::split()->get('/football/analyze/'._::$path[1],1,array('page')));

$db=_::db();
$_=array('c'=>array('$in'=>array(35)),'dd'=>array('$exists'=>false));
...
_::$content=$template->fetch('football.analyze.home');

...
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/mobile.drama.css?<?php echo APP_VERSION?>">
...
<div class="bar-title">ละครย้อนหลัง+ <span><script type="text/javascript"> __th_page="mobile-drama";</script><script type="text/javascript" src="http://hits.truehits.in.th/data/t0030667.js"></script><noscript><img src="http://hits.truehits.in.th/noscript.php?id=t0030667" alt="Thailand Web Stat" border="0" width="14" height="17" /></noscript></span></div>
<a href="/drama/print" class="bar-print"></a>
<a href="<?php echo URL?>" class="bar-refresh"></a>
</div>
</div>

<ul class="tabs"><li><a href="/drama" class="<?php echo !_::$path[0]?'active':''?>"><span>ละคร</span></a></li><li><a href="/drama/sitcom" class="<?php echo _::$path[0]=='sitcom'?'active':''?>"><span>ซิทคอม</span></a></li><li><a href="/drama/apps" class="<?php echo _::$path[0]=='apps'?'active':''?>"><span>แอพแนะนำ</span></a></li></ul>

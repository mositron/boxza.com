...
<h2><?php if($this->tv['count']):?><?php echo $this->tv['count']?> ตอน, ล่าสุด <?php echo time::show($this->tv['last'],'date',1)?><?php else:?>เร็วๆนี้<?php endif?></h2>
</a>
</li>
</ul>
...
<li>
<a href="javascript:;" onClick="expand(this)">ตอนที่ <?php echo $c-$i?> : <?php echo time::show($v['ds'],'date',1)?></a>
<ul>

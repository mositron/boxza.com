...
{
	$db=_::db();
	if(!$news=$db->findone('news',array('_id'=>intval(_::$path[0]),'dd'=>array('$exists'=>false),'pl'=>1),array('_id'=>1,'c'=>1,'cs'=>1,'cs2'=>1,'t'=>1,'sm'=>1,'d'=>1,'rf'=>1,'u'=>1,'da'=>1,'exl'=>1,'url'=>1,'do'=>1,'tags'=>1,'ds'=>1,'fd'=>1)))
	{
		_::move('/');
	}
...
_::$meta['title']=$news['t'].' - '.implode(' ',$ctitle).' ข่าวการเมือง ข่างการเมืองล่าสุด ข่าวการเมืองวันนี้';
_::$meta['description']=$news['t'].' - '.implode(' ',$ctitle).' ข่าวการเมือง ข่างการเมืองล่าสุด ข่าวการเมืองวันนี้ ข้อมูลการเมือง สถานะการณ์การเมืองวันนี้';
_::$meta['keywords']=implode(', ',$ctitle).', ข่าวการเมือง, วันนี้, ล่าสุด, พรรค, นักการเมือง';

...
<tr><td style="width:120px; text-align:right">เวลาในการแสดงผล</td><td><?php echo time::show($this->banner['dt1'],'date')?> - <?php echo time::show($this->banner['dt2'],'date')?></td></tr>
...
<script type="text/javascript" src="http://s0.boxza.com/static/js/jquery/flot/jquery.flot.js"></script>
<script>

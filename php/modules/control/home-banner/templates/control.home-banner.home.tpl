...
<script>
function cdel(i){_.box.confirm({title:'ลบประกาศ',detail:'คุณต้องการลบแบนเนอร์นี้หรือไม่',click:function(){_.ajax.gourl('/home-banner','delbanner',i)}});}
</script>
...
<ul class="nav nav-tabs">
  <li<?php echo !_::$path[0]?' class="active"':''?>><a href="/home-banner">ทั้งหมด</a></li>
<?php foreach($this->position as $key=>$value):?>
<li<?php echo _::$path[0]==$key?' class="active"':''?>><a href="/home-banner/<?php echo $key?>"><?php echo $value?></a></li>
<?php endforeach?>
</ul>


<table class="table" width="100%">
<tr><th class="c">ชื่อแบนเนอร์</th><th class="c">ประเภท</th><th class="c">ตำแหน่ง</th><th class="c">ลำดับ</th><th class="c">คลิก</th><th class="c">สถานะ</th><th class="a c"></th></tr>
...
<td class="a">
<a href="/home-banner/stats/<?php echo $this->banner[$i]['_id']?>" class="btn btn-mini"><i class="icon-tasks"></i></a>
<?php if($this->access):?>
<a href="/home-banner/<?php echo $this->banner[$i]['_id']?>" class="btn btn-mini"><i class="icon-wrench"></i></a>

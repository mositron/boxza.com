...
<tr>
<td id="mceupload"><form method="post" enctype="multipart/form-data" action="<?php echo URL?>"><input type="file" class="tbox" name="photo" style="float:none;"><input type="submit" class="button" value="อัพโหลด"></form></td>
<td align="right">

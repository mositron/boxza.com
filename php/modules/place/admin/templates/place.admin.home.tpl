...
<div class="gbox_header">เพิ่มสถานที่ใหม่</div>
<div class="gbox_content">
<table cellpadding="5" cellspacing="5" border="0" align="center" width="400">
<tr><td align="right">ชื่อสถานที่:</td><td align="left"><input type="text" name="name" size="50" class="tbox" required> * ต้องใส่ให้ถูกต้อง</td></tr>
</table>
<div style="color:#c00; width:390px; margin:5px;">*** ต้องใส่ชื่อให้ถูกต้องทุกครั้ง เพื่อตรวจสอบข้อมูลซ้ำ, และใช้สำหรับการสร้าง url ของหน้าสถานที่นั้นด้วยชื่อ ซึ่งไม่สามารถแก้ไขได้ ***</div>
</div>
...
<ul class="breadcrumb" style="margin-bottom:5px;">
  <li><a href="/" title="สถานที่"><i class="icon-home"></i> สถานที่</a></li>
   ...
   <li class="pull-right"><a href="javascript:;" onClick="_.box.open('#newplace')"><i class="icon-plus icon-black"></i> เพิ่มสถานที่ใหม่</a></li>
</ul>
...
<td class="d">
<a href="http://place.boxza.com/<?php echo $this->place[$i]['lk']?$this->place[$i]['lk']:$this->place[$i]['_id']?>" target="_blank"><?php echo $this->place[$i]['n']?></a><br>

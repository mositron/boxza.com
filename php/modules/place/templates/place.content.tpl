...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="สถานที่">สถานที่</a></h1>
        <h2>โรงแรม ร้านอาหาร ห้างสรรพสินค้า ร้านค้า โรงเรียน สถานศึกษา </h2>
        <!-- BEGIN - BANNER : A -->
    ...
    <div class="lg hidden-phone"> <a href="/" title="สถานที่ โรงแรม ร้านอาหาร ห้างสรรพสินค้า โรงพยาบาล ปั๊มน้ำมัน"></a> 
        <!-- BEGIN - BANNER : A -->
        <?php if($this->_banner['a']):?>
        <div>
            <ul class="_banner _banner-once">

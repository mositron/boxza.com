...
if(isset($file[$place['ty']]))
{
	if(defined('PLACE_SPLIT'))
	{
		...
		{
			require_once(__DIR__.'/place.profile.list.php');
		}
		else
		{
			_::move($p);
	...
	{
		require_once(__DIR__.'/place.profile.'.$file[$place['ty']].'.php');
	}

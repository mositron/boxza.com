...
<div class="bz_chat">
<h3 title="BoxZa Chat" class="bz_chat_lg"><a href="http://chat.boxza.com/" title="แชท"></a></h3>
<div class="bz_chat_radio"></div>
<div class="bz_chat_room"><ul><li><a href="http://chat.boxza.com/list" title="ห้องแชททั้งหมด" target="_blank"><i class="icon-all-chat"></i></a></li><li class="on"><a href="http://chat.boxza.com/manage" title="สร้างห้องแชทฟรี" target="_blank"><i class="icon-new-chat"></i></a></li></ul></div>
...
<div><iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FBoxzaNetwork&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=true&amp;font&amp;action=like&amp;height=21&amp;appId=124335767713181" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:60px; height:21px;" allowtransparency="true"></iframe><iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Ffarmmii.fasion&amp;send=false&amp;layout=button_count&amp;width=150&amp;show_faces=true&amp;font&amp;action=like&amp;height=21&amp;appId=124335767713181" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;" allowTransparency="true"></iframe></div>
...
<ul>
<li><a href="javascript:;" onClick="_.box.load('/game/item #game_item')"><img src="http://s0.boxza.com/static/images/chat/item.png" alt="ร้านค้า"><p>ร้านค้า</p></a></li>
<?php if($this->room['_id']<7):?>
<li><a href="javascript:;" onClick="_.box.load('/game/radio #game_radio')"><img src="http://s0.boxza.com/static/images/chat/radio.png" alt="ตารางดีเจประจำ BoxZa Chat"><p>ตารางเวลา PJ</p></a></li>
<?php endif?>
<li><a href="javascript:;" onClick="_.box.load('/game/online/<?php echo $this->room['_id']?> #game_online')"><img src="http://s0.boxza.com/static/images/chat/online.png" alt="ธนาคาร"><p>เวลาออนไลน์</p></a></li>
<li><a href="javascript:;" onClick="_.box.load('/game/bank #game_bank')"><img src="http://s0.boxza.com/static/images/chat/bank.png" alt="ธนาคาร"><p>ธนาคาร</p></a></li>
<li><a href="http://game.boxza.com/lionica" target="_blank"><img src="http://s0.boxza.com/static/images/chat/pet.png" alt="ร้านค้า"><p>สัตว์เลี้ยง</p></a></li>
<li><a href="javascript:;" onClick="_.box.load('/game/namtoa #game_namtoa')"><img src="http://s0.boxza.com/static/images/chat/namtoa/2.jpg" alt="เกมน้ำเต้า"><p>เกมน้ำเต้า</p></a></li>
<li><a href="javascript:;" onClick="_.box.load('/game/slave #game_slave')"><img src="http://s0.boxza.com/static/images/chat/card/card.gif" alt="เกมสลาฟ"><p>เกมสลาฟ</p></a></li>
<li><a href="javascript:;" onClick="_.box.load('/game/lottery #game_lottery')"><img src="http://s0.boxza.com/static/images/chat/lottery.png" alt="ล็อตเตอรี่"><p>ล็อตเตอรี่</p></a></li>
<li><a href="javascript:;" onClick="_.box.load('/game/thief #game_thief')"><img src="http://s0.boxza.com/static/images/chat/thief.png" alt="ขโมย"><p>ขโมย</p></a></li>
<li><a href="javascript:;" onClick="_.chat.game();$('#bz_box_game').css('display','block');"><img src="http://s0.boxza.com/static/images/chat/logs.png" alt="ขโมย"><p>หน้าต่างเกมส์</p></a></li>
</ul>
</div>
<p class="clear"></p>
</div>
<div class="bz_chat_box">
<div class="bz_chat_swf"><embed src="/_static/flash/chat/sound.swf" quality="high" wmode="transparent" id="bz_chat_swf" allowscriptaccess="always" type="application/x-shockwave-flash" width="1" height="1"></embed></div>
...
<strong></strong>
<a href="#!e1" onClick="_.chat.emoticon('e1');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/1.gif" /></a>
<a href="#!e2" onClick="_.chat.emoticon('e2');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/2.gif" /></a>
<a href="#!e3" onClick="_.chat.emoticon('e3');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/3.gif" /></a>
<a href="#!e4" onClick="_.chat.emoticon('e4');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/4.gif" /></a>
<a href="#!e5" onClick="_.chat.emoticon('e5');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/5.gif" /></a>
<a href="#!e6" onClick="_.chat.emoticon('e6');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/6.gif" /></a>
<a href="#!e7" onClick="_.chat.emoticon('e7');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/7.gif" /></a>
<a href="#!e8" onClick="_.chat.emoticon('e8');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/8.gif" /></a>
<a href="#!e9" onClick="_.chat.emoticon('e9');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/9.gif" /></a>
<a href="#!e10" onClick="_.chat.emoticon('e10');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/10.gif" /></a>
<a href="#!e11" onClick="_.chat.emoticon('e11');return false;"><img src="http://s0.boxza.com/static/chat/emoticon/e/11.gif" /></a>

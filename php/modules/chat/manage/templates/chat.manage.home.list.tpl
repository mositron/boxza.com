...
<td class="tab_time"><?php echo time::show($this->chat[$i]['da'],'datetime')?></td>
 <td class="text-center">
 <a href="<?php echo $this->chat[$i]['l']?$this->chat[$i]['l']:'/room/'.$this->chat[$i]['_id']?>" target="_blank"><img src="http://s0.boxza.com/static/images/global/view.gif" alt="ไปยังห้องแชท"></a>
    	<a href="/manage/<?php echo $this->chat[$i]['_id']?>" class="h"><img src="http://s0.boxza.com/static/images/global/edit.gif" alt="แก้ไขข้อมูลเบื้องต้น"></a>
      <a href="javascript:;" onClick="adel(<?php echo $this->chat[$i]['_id']?>)"><img src="http://s0.boxza.com/static/images/global/del.gif" alt="ลบ"></a>
     </td>
   </tr>
<?php endfor?>

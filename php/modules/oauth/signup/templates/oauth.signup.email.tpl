...
<td>
<input type="email" name="email" class="tbox inp" value="<?php echo $this->value['email']?>" required>
...
<td><input type="file" name="photo" class="tbox" style="width:160px" required><div id="err_photo" class="err"><?php echo $this->error['photo']?></div></td>
</tr>
<tr>
<td width="30%" class="text-right"></td>
<td><label><input type="checkbox" name="terms" class="tbox" value="yes"<?php echo $this->value['terms']?' checked':''?> required> ยอมรับ<a href="//boxza.com/about/privacy" target="_blank">เงื่อนไขการใช้งาน</a></label><div id="err_terms" class="err"><?php echo $this->error['terms']?></div></td>
</tr>
<!--tr>
...
<tr><td></td><td><input type="submit" class="olg-btn olg-btn-reg" value=" สมัครสมาชิก "> <br>
หรือสมัครสมาชิกด้วย <a href="/signup/facebook/<?php echo $this->q?>">Facebook</a><br><br>
</td></tr>
</table>
</form>
<!--div class="olg-point">รับบ๊อกฟรีทันที เมื่อสมัครสมาชิกผ่านระบบ <a href="/signup/facebook/<?php echo $this->q?>" rel="nofollow">Facebook</a></div-->
</div>
<style>
...
//$(function(){ _.box.confirm({title:'ปิดรับสมัครชั่วคราว',detail:'ขอขอบคุณทุกท่านที่ให้ความสนใจนะครับ ทางเราขอปิดการรับสมัครสมาชิก(เพิ่ม)ชั่วคราว เพื่อปรับปรุงระบบให้ดีขึ้น.',yes:'กลับไปหน้าแรก',no:'ปิดหน้าต่างนี้',click:function(){window.location.href='//boxza.com/'}}); })
</script>
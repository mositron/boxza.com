...
<title>BoxZa - โซเชียลเน็ทเวิร์คสัญชาติไทย</title>
</head>
...
คลิกที่ลิ้งค์ด้านล่างนี้เพื่อลบข้อความของคุณ<br>
 <a href="http://friend.boxza.com/report/?delete=<?php echo $this->f['_id'].'.'.$this->code?>" style="color:#0399BE;">http://friend.boxza.com/report/?delete=<?php echo $this->f['_id'].'.'.$this->code?></a><br>

...
บริการข้อมูลแบบบ้าน: 
<a href="http://feed.boxza.com/news-<?php echo NEWS_CATE?>/rss" title="บริการข้อมูลแบบบ้าน โดย RSS Feed" target="_blank"><img src="http://s0.boxza.com/static/images/global/rss.png" title="บริการข้อมูลแบบบ้าน โดย RSS Feed"></a>
<a href="http://feed.boxza.com/news-<?php echo NEWS_CATE?>/json" title="บริการข้อมูลแบบบ้าน โดย JSON" target="_blank"><img src="http://s0.boxza.com/static/images/global/json.png" title="บริการข้อมูลแบบบ้าน โดย JSON"></a>
<a href="http://feed.boxza.com/news-<?php echo NEWS_CATE?>/json/change_callback_function_here" title="บริการข้อมูลแบบบ้าน โดย JSONP" target="_blank"><img src="http://s0.boxza.com/static/images/global/jsonp.png" title="บริการข้อมูลแบบบ้าน โดย JSONP"></a>
</div>
</div>

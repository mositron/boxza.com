...
<div class="container">
    <hgroup class="head-logo">
        <h1><a href="/" title="บ้าน แบบบ้าน">บ้าน</a></h1>
        <h2>แบบบ้าน ตกแต่งบ้าน ออกแบบบ้าน บ้านและสวน จัดสวน ตกแต่ง ห้องนอน ห้องรับแขก</h2>
        <!-- BEGIN - BANNER : A -->
		...
		<nav class="navbar navbar-inverse hbar">
            <div class="navbar-inner">
                <div class="container"> 
                    ...
                    <a class="brand" href="/" title="แบบบ้าน ตกแต่งบ้าน ออกแบบบ้าน">แบบบ้าน</a>

...
_::$meta['title']=$news['t'].' - '.implode(' ',$ctitle).' ข่าววันนี้ ข่าวล่าสุด';
_::$meta['description']=$news['t'].' - '.implode(' ',$ctitle).' ข่าววันี้ ข่าวล่าสุด ข่าวไอที ทิป-เทคนิค บทความน่ารู้ Gadget แอพแนะนำ ราคา iphone ipad';
_::$meta['keywords']=implode(', ',$ctitle).', Technology, iPhone, iPad, App, iOS, Android, Apple, Google';

...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="เทคโนโลยี">เทคโนโลยี</a></h1>
        <h2>เทคโนโลยี ข่าวไอที ทิป-เทคนิค บทความน่ารู้ Gadget แอพแนะนำ</h2>
        <!-- BEGIN - BANNER : A -->
		...
		<nav class="navbar navbar-inverse hbar">
            <div class="navbar-inner">
                <div class="container"> 
                    ...
                    <a class="brand" href="/" title="เทคโนโลยี">เทคโนโลยี</a>

...
<script type="text/javascript" src="http://s0.boxza.com/static/js/tiny_mce/tiny_mce_popup.js"></script>
<script type="text/javascript" src="http://s0.boxza.com/static/js/tiny_mce/utils/mctabs.js"></script>
<script type="text/javascript" src="http://s0.boxza.com/static/js/tiny_mce/utils/form_utils.js"></script>
<script type="text/javascript" src="http://s0.boxza.com/static/js/tiny_mce/utils/validate.js"></script>
<script type="text/javascript" src="http://s0.boxza.com/static/js/tiny_mce/utils/editable_selects.js"></script>
</head>
<body>
...
<tr>
<td id="mceupload"><form method="post" enctype="multipart/form-data" action="<?php echo URL?>"><input type="file" class="tbox" name="photo[]" style="float:none;" multiple><input type="submit" class="button" value="อัพโหลด"></form></td>
<td align="right">
<label><input type="checkbox" id="addclose" value="1" checked> ปิดหน้าต่างนี้ เมื่อเพิ่มรูปหรือไฟล์เข้าเนื้อหา</label></td>
</tr>
</table>

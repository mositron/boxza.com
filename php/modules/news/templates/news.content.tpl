...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="ข่าว">ข่าว</a></h1>
        <h2>ข่าววันนี้ ข่าวล่าสุด ข่าวด่วน ข่าวสด ข่าวเด่น</h2>
        <!-- BEGIN - BANNER : A -->
        ...
        <nav class="navbar hbar">
            <div class="navbar-inner">
                <div class="container"> 
                    ...
                    <a class="brand" href="/" title="ข่าว ข่าววันนี้ ข่าวเด่น ข่าวการเมือง ข่าวด่วน">ข่าว</a>
                    <div class="nav-collapse collapse">
                    	<ul class="nav">
							<?php foreach($this->cate as $k=>$v): if($v['sub']||$k==1||$k==8||$k==12||$k>13)continue;?>
                        ...
                        <ul class="nav pull-right">
                            <li><a href="/admin">+ เขียนข่าว</a></li>
                        </ul>
                    </div>
                </div>
            </div>

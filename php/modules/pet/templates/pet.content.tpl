...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="สัตว์เลี้ยง">สัตว์เลี้ยง</a></h1>
        <h2>สัตว์เลี้ยง สุนัข หมา แมว นก ปลา กระต่าย หนู ซื้อขาย แลกเปลี่ยน</h2>
        <!-- BEGIN - BANNER : A -->
		...
		<nav class="navbar navbar-inverse hbar">
            <div class="navbar-inner">
                <div class="container"> 
                    ...
                    <a class="brand" href="/" title="สัตว์เลี้ยง">สัตว์เลี้ยง</a>

...
<h3 class="hbu"><i></i>BOYZ UPDATE</h3>
...
<div class="slider-wrapper theme-default">
   ...
   <a href="<?php echo $this->banner[$i]['l']?>"><img src="http://s3.boxza.com/boyz/banner/<?php echo $this->banner[$i]['_id']?>.jpg" title="<?php echo $this->banner[$i]['d']?>" alt=""></a>
   <?php endfor?>
   </div>
</div>
...
<div class="row-fluid" style="padding-top:5px;margin-top:5px;border-top:1px solid #000;">
<div class="hht span6">
<h3><a href="/forum/c-75" title="เกย์: สุขภาพ ศัลกรรม ความงาม"><i></i>HEALTHY</a></h3>
<div><a href="/forum/c-75" title="เกย์: สุขภาพ ศัลกรรม ความงาม"><img src="http://s0.boxza.com/static/images/boyz/healthy.jpg" alt="สุขภาพ ศัลกรรม ความงาม"></a></div>
<ul class="flist1">
...
<div class="hfs span6">
<h3><a href="/forum/c-74" title="เกย์: แฟชั่น การแต่งตัว อัพเดทเทรนใหม่"><i></i>FASHION</a></h3>
<div><a href="/forum/c-74" title="เกย์: แฟชั่น การแต่งตัว อัพเดทเทรนใหม่"><img src="http://s0.boxza.com/static/images/boyz/fashion.jpg" alt="แฟชั่น การแต่งตัว อัพเดทเทรนใหม่"></a></div>
<ul class="flist1">
...
<div class="hr hr2">
<h3><a href="/friend" title="หาเพื่อนเกย์"><i></i> หาเพื่อนเกย์</a></h3>
<div>
...
<div class="fb-like-box" data-href="https://www.facebook.com/pages/BoxZa-Boyz/157051084438090" data-width="320" data-height="240" data-show-faces="true" data-border-color="#fff" data-stream="false" data-header="false"></div>
</div>

...
<?php endif?>
<!-- END - BANNER : D -->
<h3 style="padding:5px; margin:5px 0px 5px; background:#f0f0f0">แชทเกย์ ห้องแชทชาวเกย์ พูดคุยของชาวเกย์ สนทนาตามประสาชาวเกย์</h3>

<div style="margin:5px 0px"><?php require(HANDLERS.'ads/ads.yengo.body3.php');?></div>

<iframe frameborder="0" width="100%" height="650" src="http://s0.boxza.com/static/chat/?f=0&r=2"></iframe>

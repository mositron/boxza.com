...
<ul class="breadcrumb" style="margin-bottom:5px;">
  <li><a href="/" title="เกย์ ชายรักชาย"><i class="icon-home icon-white"></i> เกย์</a></li>
...
<tr><td class="colum">รูปภาพ</td><td><img src="http://s3.boxza.com/boyz/banner/<?php echo $this->banner['_id']?>.jpg" id="thumb"> <br>
...
$('input[name=thumb]').change(function(e){
	if($(this).val())
	{
		_.upload.start(
			this,
			function(f){f.append('<input type="hidden" name="ans" value="'+$(this).attr('ans')+'">');},
			function(b){if(b.status=='OK'){$('#thumb').attr('src',b.pic);}else{_.box.alert(b.message);}}
		);
	}
});
</script>
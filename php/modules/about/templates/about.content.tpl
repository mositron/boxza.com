...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="คลังข้อมูล">คลังข้อมูล</a></h1>
        <h2>ศูนย์รวมข้อมูล ข้อมูลน่าสนใจ</h2>
        <!-- BEGIN - BANNER : A -->
        ...
        <nav class="navbar hbar">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a class="brand" href="/" title="คลังข้อมูล ความรู้ ประวัติ">คลังข้อมูล</a>
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                            <li><a href="/person" title="บุคคล">บุคคล</a></li>
                            <li><a href="/place" title="สถานที่">สถานที่</a></li>
                            <li><a href="/day" title="วันสำคัญ">วันสำคัญ</a></li>
                            <li><a href="/activity" title="กิจกรรม">กิจกรรม</a></li>
                            <li><a href="/other" title="ข้อมูลอื่นๆ">อื่นๆ</a></li>
                        </ul>
                        <?php if(_::$my['am']):?>
                        <ul class="nav pull-right">
                        <li><a href="/admin"><i class="icon-edit"></i> เขียนข้อมูล</a></li>
                        </ul>
                        <?php endif?>
                    </div>
                </div>

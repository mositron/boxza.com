...
<a href="javascript:;" onClick="selectf('<?php echo htmlentities($this->file[$i],ENT_QUOTES)?>','http://s3.boxza.com/about/<?php echo $this->about['fd'].'/'.$this->file[$i]?>')" style="display:block; cursor:pointer"><img src="http://s3.boxza.com/about/<?php echo $this->about['fd'].'/'.$this->file[$i]?>" class="img-t"></a>

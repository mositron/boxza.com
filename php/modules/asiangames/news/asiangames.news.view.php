...
_::$meta['title']=$news['t'].' - ข่าว '.implode(' ',$ctitle).' ข่าวบันเทิง ข่าวล่าสุด ข่าววันนี้';
_::$meta['description']=$news['t'].' - ข่าว '.implode(' ',$ctitle).' ข่าวบันเทิง ข่าวล่าสุด ข่าววันนี้ ข่าวด่วน ข่าวเด่น';
_::$meta['keywords']=implode(', ',$ctitle).', ข่าว, ล่าสุด, ดารา, วันนี้, ข่าวล่าสุด, ข่าววันนี้';
...
$template->assign('c',($news['c']==5?8:$news['cs']));

...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="ราคาทอง">ราคาทอง</a></h1>
        <h2>ราคาทอง ราคาทองรูปพรรณวันนี้ ราคาทองคำแท่งล่าสุด</h2>
        <!-- BEGIN - BANNER : A -->
        ...
        <nav class="navbar hbar">
            <div class="navbar-inner">
                <div class="container"> 
                    ...
                    <a class="brand" href="/" title="ราคาทอง ราคาทองรูปพรรณ ราคาทองคำแท่ง ราคาทองคำวันนี้ ราคาทองคำล่าสุด">ราคาทองคำ</a>

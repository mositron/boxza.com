...
<div data-role="dialog" data-close-btn="right" class="bz-dialog-line-view">
  <div data-role="header">
    <h2></h2>
  </div>
  <div data-role="content" style="padding:0px 0px 5px 0px;">
<div id="_line" class="line">
...
<?php if($l['pt']['tmp']):?>
<div class="pt pt-once">
<img src="http://s1.boxza.com/line/<?php echo $l['pt']['f']?>/o.<?php echo $l['pt']['e']?>">
</div>
...
<div class="av"><a href="/<?php echo $c['u']['_id']?>" class="h" title="<?php echo $c['u']['name']?>"><img src="<?php echo $c['u']['img']?>" class="img-uid-<?php echo $c['u']['_id']?>"></a></div>
<div class="cm-d">
<div class="cm-r">
<span class="ago" datetime="<?php echo $c['t']?>"></span>

<span class="cm-u"><a href="/<?php echo $c['u']['_id']?>" class="h"><?php echo $c['u']['name']?></a></span>
<div class="clear"></div>
</div>
...
<div class="cm-p cm-p-<?php echo $l['_id']?>">
<div><textarea class="tbox" data-cm="<?php echo $l['_id']?>" style="width:100%; height:40px" onKeyPress="return _.profile.cm.post(event,this)" placeholder="แสดงความคิดเห็น..."></textarea></div>
</div>
</div>

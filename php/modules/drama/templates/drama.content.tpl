...
<div class="container">
    <hgroup class="head-logo">
        <h1><a href="/" title="ละคร เรื่องย่อละคร">ละคร</a></h1>
        <h2>ละคร เรื่องย่อละคร ละครย้อนหลัง ดูละคร</h2>
        <!-- BEGIN - BANNER : A -->
        ...
        <nav class="navbar hbar navbar-inverse">
            <div class="navbar-inner">
                <div class="container"> 
                    ...
                    <a class="brand" href="/" title="ละคร เรื่องย่อละคร">ละคร</a>
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav pull-right">
                            <li><a href="/admin">+ เพิ่มละคร</a></li>
                        </ul>
                       	<?php endif?>
                    </div>
                </div>

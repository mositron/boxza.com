...
_::$meta['title']=$news['t'].' - '.implode(' ',$ctitle).' สถานที่ท่องเที่ยว เทศกาล ที่พัก โรงแรม ร้านอาหาร';
_::$meta['description']=$news['t'].' - '.implode(' ',$ctitle).' เที่ยวกลางคืน ที่พัก สถานที่ท่องเที่ยว เทศกาล ที่พัก โรงแรม ร้านอาหาร';
_::$meta['keywords']=implode(', ',$ctitle).', สถานที่ท่องเที่ยว, กลางคืน, ร้านอาหาร, ที่พัก, โรงแรม';

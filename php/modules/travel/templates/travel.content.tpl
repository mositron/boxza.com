...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="ท่องเที่ยว">ท่องเที่ยว</a></h1>
        <h2>สถานที่ท่องเที่ยว ท่องเที่ยว เทศกาล ที่พัก โรงแรม ร้านอาหาร</h2>
        <!-- BEGIN - BANNER : A -->
		...
		<nav class="navbar navbar-inverse hbar">
            <div class="navbar-inner">
                <div class="container"> 
                    ...
                    <a class="brand" href="/" title="ท่องเที่ยว">ท่องเที่ยว</a>
                    <div class="nav-collapse collapse">
                    	<ul class="nav">
                        <?php foreach($this->cate as $v):?>
                            <li><a href="/<?php echo $v['l']?>" title="<?php echo $v['t']?>"><?php echo $v['t']?></a></li>
                        <?php endforeach?>
                        </ul>
                    </div>
                </div>

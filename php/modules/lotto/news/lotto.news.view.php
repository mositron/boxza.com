...
_::$meta['title']=$news['t'].' - '.implode(' ',$ctitle).' ตรวจหวย หวยหุ้น เลขเด็ดหวย เลขเด็ดหวยหุ้น เลขเด็ดวันนี้';
_::$meta['description']=$news['t'].' - '.implode(' ',$ctitle).' ตรวจหวย ตรวจฉลากกินแบ่ง สลากกินแบ่งรัฐบาล หวยหุ้น ห้วยหุ้นไทย หวยเด็ด อัพเดทรวดเร็ว';
_::$meta['keywords']=implode(', ',$ctitle).', ตรวจหวย, ตรวจสลากกินแบ่งรัฐบาล, ตรวจสลากกินแบ่ง';

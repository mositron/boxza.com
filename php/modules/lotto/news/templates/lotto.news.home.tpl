...
บริการข้อมูลหวย <?php echo $this->cate[$this->c]['t']?>: 
<a href="http://feed.boxza.com/news-<?php echo NEWS_CATE?>-<?php echo $this->c?>/rss" title="บริการข้อมูลข่าวหวย <?php echo $this->cate[$this->c]['t']?>โดย RSS Feed" target="_blank"><img src="http://s0.boxza.com/static/images/global/rss.png" title="บริการข้อมูลข่าวหวย <?php echo $this->cate[$this->c]['t']?>โดย RSS Feed"></a>
<a href="http://feed.boxza.com/news-<?php echo NEWS_CATE?>-<?php echo $this->c?>/json" title="บริการข้อมูลข่าวหวย <?php echo $this->cate[$this->c]['t']?>โดย JSON" target="_blank"><img src="http://s0.boxza.com/static/images/global/json.png" title="บริการข้อมูลข่าวหวย <?php echo $this->cate[$this->c]['t']?>โดย JSON"></a>
<a href="http://feed.boxza.com/news-<?php echo NEWS_CATE?>-<?php echo $this->c?>/json/change_callback_function_here" title="บริการข้อมูลข่าวหวย <?php echo $this->cate[$this->c]['t']?>โดย JSONP" target="_blank"><img src="http://s0.boxza.com/static/images/global/jsonp.png" title="บริการข้อมูลข่าวหวย <?php echo $this->cate[$this->c]['t']?>โดย JSONP"></a>
</div>
</div>

...
_::$meta['title']=$news['t'].' - '.implode(' ',$ctitle).' ข่าวการศึกษา ทุนการศึกษา คลังข้อสอบ เรียนต่อต่างประเทศ';
_::$meta['description']=$news['t'].' - '.implode(' ',$ctitle).' ข่าวการศึกษา admission คลังข้อสอบ ทุนการศึกษา การเรียนต่อในประเทศและต่างประเทศ';
_::$meta['keywords']=implode(', ',$ctitle).', ข่าวการศึกษา, ทุนการศึกษา, คลังข้อสอบ, เรียนต่อ, ต่างประเทศ, โรงเรียน, มหาวิทยาลัย';

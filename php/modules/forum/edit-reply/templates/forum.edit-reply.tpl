...
<?php if(_::$my):?><li class="pull-right" style="margin-left:10px;"><a href="<?PHP echo FORUM_URL?>setting"><i class="icon-barcode"></i> ปรับแต่งเว็บบอร์ด</a></li><?php endif?>
</ul> 
...
<form action="<?php echo URL?>" method="post" enctype="multipart/form-data" onSubmit="tinyMCE.triggerSave();" name="post" id="spost">
  <table border="0" cellpadding="3" cellspacing="1" class="forum_post" align="center">
	<tr> 
		<th class="head" colspan="2" height="25">แก้ไขตอบกระทู้</th>
	</tr>
   <tr><td colspan="2"><div style="padding:5px; text-align:center; border:1px solid #f00; color:#f00; margin:5px 0px;">ห้ามโฆษณาเว็บ หรือโปรโมทเว็บ<strong>โดยเด็ดขาด</strong>!. หากฝ่าฝืน ลบกระทู้+ลบโพสต์+แบนไอดีสมาชิกทันที!.</div></td></tr>
 	<tr> 

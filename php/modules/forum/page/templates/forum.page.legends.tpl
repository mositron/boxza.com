...
<?php endif?>
<!-- END - BANNER : B -->
<h3 class="forum_cp" style="margin:5px 0px"><a href="/c-64">พูดคุยเกี่ยวกับเกม Legends: Rise of a Hero(เลเจนด์: ริซออฟอะฮีโร่)</a> <small>(<a href="/new-topic/64">เพิ่มกระทู้ใหม่</a>)</small></h3>
...
ดูกระทู้ที่เกี่ยวกับ Legends: Rise of a Hero(เลเจนด์: ริซออฟอะฮีโร่) ทั้งหมด <a href="/c-64">คลิกที่นี่</a>
</div>

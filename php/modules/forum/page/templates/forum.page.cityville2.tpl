...
<?php endif?>
<!-- END - BANNER : B -->
<h3 class="forum_cp" style="margin:5px 0px"><a href="/c-63">พูดคุยเกี่ยวกับเกมซิตี้วิลล์2 CityVille 2</a> <small>(<a href="/new-topic/63">เพิ่มกระทู้ใหม่</a>)</small></h3>
...
ดูกระทู้ที่เกี่ยวกับซิตี้วิลล์ ทั้งหมด <a href="/c-63">คลิกที่นี่</a>
</div>
</div>

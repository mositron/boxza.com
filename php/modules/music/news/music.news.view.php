...
_::$meta['title']=$news['t'].' - '.implode(' ',$ctitle).' เพลงใหม่ เนื้อเพลงใหม่ MVใหม่ อัลบั้มใหม่';
_::$meta['description']=$news['t'].' - '.implode(' ',$ctitle).' ค้นหาเพลง เพลงใหม่ เนื้อเพลงใหม่ MVใหม่ อัลบั้มใหม่';
_::$meta['keywords']=implode(', ',$ctitle).', เพลงใหม่, เนื้อเพลง, เนื้อเพลงใหม่, MV, อัลบั้มใหม่';

...
<ul class="breadcrumb">
<li><a href="/" title="เพลง เนื้อเพลง"><i class="icon-home"></i> เพลง</a></li>
...
<div class="bx">
<div class="cv"><img src="<?php echo _::$meta['image']?>" alt="<?php echo $this->music['sn']?> - <?php echo $this->music['al']?> - <?php echo $this->music['ar']?>"></div>
<div class="dt">
...
<?php #require(HANDLERS.'ads/ads.adsense.body-responsive.php');?>
...
<td style="text-align:center; width:150px"><?php echo time::show($this->music['fs'][$i]['da'],'datetime')?></td>
</tr>
<?php $j++;endfor?>
</tbody>
</table>
...
โหลดเพลง  <?php echo $this->music['sn2']?> ดาวน์โหลด <?php echo $this->music['sn2']?> .mp3 <?php echo $this->music['sn2']?> Chord <?php echo $this->music['sn2']?> 
คอร์ด <?php echo $this->music['sn2']?> Lyric <?php echo $this->music['sn2']?> เนื้อเพลง <?php echo $this->music['sn2']?> midi <?php echo $this->music['sn2']?> 
download <?php echo $this->music['sn2']?> ดาว์นโหลด <?php echo $this->music['sn2']?> 
ijigg <?php echo $this->music['sn2']?> MediaFire <?php echo $this->music['sn2']?> MIXPOD <?php echo $this->music['sn2']?> 4shared.com <?php echo $this->music['sn2']?> imeem
</div>


<h4 style="margin:10px 0px 0px 0px; padding:5px; text-align:center; background:#f9f9f9;">แสดงความคิดเห็นด้วย Facebook</h4>
<div class="fb-comments" data-href="http://music.boxza.com/lyric/<?php echo $this->music['_id']?>" data-num-posts="10" data-width="720"></div>
...
<?php if(_::$my['am']):?>h+='<div class="amvid"><a href="javascript:" onclick="_.ajax.gourl(\'<?php echo URL?>\',\'setvdo\',\''+v+'\');">ตั้งวิดีโอนี้เป็นเพลงหลักของเนื้อเพลงนี้</a></div>';<?php endif?>
	$('#svid').html(h);
}
</script>
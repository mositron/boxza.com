...
<div class="container">
	<hgroup class="head-logo">
    	<h1><a href="/" title="แม่และเด็ก">แม่และเด็ก</a></h1>
        <h2>แม่และเด็ก การตั้งครรภ์ ให้นมลูก ตั้งชื่อลูก</h2>
        <!-- BEGIN - BANNER : A -->
		...
		<nav class="navbar navbar-inverse hbar">
            <div class="navbar-inner">
                <div class="container"> 
                    ...
                    <a class="brand" href="/" title="แม่และเด็ก ตั้งครรภ์ ให้นมลูก ตั้งชื่อลูก">แม่และเด็ก</a>

...
บริการข้อมูลแม่และเด็ก: 
<a href="http://feed.boxza.com/news-<?php echo NEWS_CATE?>/rss" title="บริการข้อมูลแม่และเด็ก โดย RSS Feed" target="_blank"><img src="http://s0.boxza.com/static/images/global/rss.png" title="บริการข้อมูลแม่และเด็ก โดย RSS Feed"></a>
<a href="http://feed.boxza.com/news-<?php echo NEWS_CATE?>/json" title="บริการข้อมูลแม่และเด็ก โดย JSON" target="_blank"><img src="http://s0.boxza.com/static/images/global/json.png" title="บริการข้อมูลแม่และเด็ก โดย JSON"></a>
<a href="http://feed.boxza.com/news-<?php echo NEWS_CATE?>/json/change_callback_function_here" title="บริการข้อมูลแม่และเด็ก โดย JSONP" target="_blank"><img src="http://s0.boxza.com/static/images/global/jsonp.png" title="บริการข้อมูลแม่และเด็ก โดย JSONP"></a>
</div>
</div>

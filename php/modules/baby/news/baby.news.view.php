...
_::$meta['title']=$news['t'].' - '.implode(' ',$ctitle).' ตั้งชื่อลูก คู่มือคุณแม่ การตั้งครรภ์';
_::$meta['description']=$news['t'].' - '.implode(' ',$ctitle).' ตั้งชื่อลูก คู่มือคุณแม่ การตั้งครรภ์';
_::$meta['keywords']=implode(', ',$ctitle).', ตั้งชื่อลูก, คู่มือคุณแม่, ตั้งครรภ์';

...
<meta property="og:site_name" content="รถแต่ง">
...
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/racing.css">
...
<body class="body-<?php echo MODULE?>">
<?php echo _::$content?>
<div id="fb-root"></div>

...
<h2 style="padding:5px; margin:5px; background:#f9f9f9; text-align:center"><?php echo $this->brand['en']?> (<?php echo $this->brand['th']?>)</h2>
...
<?php echo $this->html->tr('ชื่อภาษาไทย','brand_th_'.$this->brand['_id'],$this->brand['th'],'input',array('full'=>10,'enabled'=>$this->canedit))?>
<?php echo $this->html->tr('ชื่อภาษาอังกฤษ','brand_en_'.$this->brand['_id'],$this->brand['en'],'input',array('full'=>10,'enabled'=>$this->canedit))?>
<?php echo $this->html->tr('ลิ้งค์','brand_link_'.$this->brand['_id'],$this->brand['link'],'input',array('full'=>10,'enabled'=>$this->canedit))?>
</table>
</div>

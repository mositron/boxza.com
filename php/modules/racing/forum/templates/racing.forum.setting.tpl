...
<li><a href="/forum/setting" title="ปรับแต่งค่าในเว็บบอร์ด"><i class="icon-white icon-list"></i> ปรับแต่งเว็บบอร์ด</a></li>
<?php if(_::$my):?>
...
<textarea style="height:300px; width:600px;" name="detail" class="mceEditor" minlength="20"><?php echo $this->user['sg']?></textarea>

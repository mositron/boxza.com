...
<meta property="og:site_name" content="เกมส์">
...
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/game.css">
<?php if(defined('LIONICA')):?>
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/boxza.<?php echo LIONICA?>.css?v=<?php echo $time=time()?>">
<?php endif?>
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/boxza.lionica.char.css">
...
<?php if(defined('LIONICA')):?>
<script type="text/javascript" src="http://s0.boxza.com/static/js/three/stats.min.js"></script>
<script type="text/javascript" src="http://s0.boxza.com/static/js/boxza.<?php echo LIONICA?>.js?v=<?php echo $time?>"></script>
<!--[if IE]><script type="text/javascript" src="http://s0.boxza.com/static/js/excanvas/excanvas.js"></script><![endif]-->
<?php endif?>

...
<div class="left pf-l">
<div style="line-height:0px;"><img src="http://s0.boxza.com/static/images/fb/hd-legends.jpg" alt=" Legends: Rise of a Hero (เลเจนด์: ริซออฟอะฮีโร่)"></div>
 <!-- BEGIN - BANNER : B -->
...
<?php endif?>
<!-- END - BANNER : B -->
<h3 class="forum_cp" style="margin:5px 0px"><a href="/forum/legends">พูดคุยเกี่ยวกับเกม Legends: Rise of a Hero(เลเจนด์: ริซออฟอะฮีโร่)</a> <small>(<a href="/forum/new-topic/64">เพิ่มกระทู้ใหม่</a>)</small></h3>
...
ดูกระทู้ที่เกี่ยวกับ Legends: Rise of a Hero(เลเจนด์: ริซออฟอะฮีโร่) ทั้งหมด <a href="/forum/legends">คลิกที่นี่</a>
</div>
...
<strong>CityVille2</strong> - ศูนย์รวมคนเล่นเกม Legends: Rise of a Hero แลกเปลี่ยนเทคนิคการเล่น โปรแกรมบอท โปรแกรมโกง Cheats Speed Hack
เช่น โกงเงิน โกงพลัง โกงเลเวล ปั๊มเลเวล หาเพื่อนเล่นเกม Legends: Rise of a Hero(เลเจนด์: ริซออฟอะฮีโร่)
</div>

<h3 class="forum_cp" style="margin:5px 0px"><i></i> Follow US on Facebook</h3>
<div class="fb-like-box" data-href="https://www.facebook.com/Legends.TH" data-width="245" data-height="400" data-show-faces="true" data-border-color="#eee" data-stream="false" data-header="false" style="margin-bottom:5px;"></div>
</div>
<div class="clear"></div>
</div>

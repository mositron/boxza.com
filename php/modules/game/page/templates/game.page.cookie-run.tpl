...
<div class="left pf-l">
<div style="line-height:0px"><img src="http://s0.boxza.com/static/images/fb/hd-cookie-run.jpg" alt="Cookie Run"></div>
 <!-- BEGIN - BANNER : B -->
...
<?php endif?>
<!-- END - BANNER : B -->
<h3 class="forum_cp" style="margin:5px 0px"><a href="/forum/cookie-run">พูดคุยเกี่ยวกับเกมคุกกี้รัน Cookie Run</a> <small>(<a href="/forum/new-topic/52">เพิ่มกระทู้ใหม่</a>)</small></h3>
...
ดูกระทู้ที่เกี่ยวกับคุกกี้รัน ทั้งหมด <a href="/forum/cookie-run">คลิกที่นี่</a>
</div>
</div>
...
<strong>Cookie Run</strong> - ศูนย์รวมคนเล่นเกมคุกกี้รัน CookieRun แลกเปลี่ยนเทคนิคการเล่น โปรแกรมบอท โปรแกรมโกง Cheats Speed Hack
...
- <a href="/forum/topic/483" target="_blank">โกงเลเวล ปั๊มเลเวล CookieRun</a><br>
- <a href="/forum/topic/604" target="_blank">โกงเงินเขียว CookieRun</a><br>
- <a href="/forum/topic/426" target="_blank">โกงเงิน CookieRun</a><br>
- <a href="/forum/topic/745" target="_blank">กำจัดหินและไม้ CookieRun</a><br>
- <a href="/forum/topic/715" target="_blank">โกงไซโล เพิ่มไซโล CookieRun</a><br>
- <a href="/forum/topic/590" target="_blank">โกงรางร่มเงา เพิ่มรางร่มเงา CookieRun</a><br>
- <a href="/forum/topic/36" target="_blank">หาเพื่อน CookieRun</a-->
</div>

<h3 class="forum_cp" style="margin:5px 0px"><i></i> Follow US on Facebook</h3>
<div class="fb-like-box" data-href="https://www.facebook.com/BoxzaNetwork" data-width="245" data-height="400" data-show-faces="true" data-border-color="#eee" data-stream="false" data-header="false" style="margin-bottom:5px;"></div>
</div>
<div class="clear"></div>
</div>

...
<?php if($this->pj):?>
<div style="padding:5px; text-align:center; background:#f5f5f5; text-shadow:1px 1px 0px #fff;">ตารางเวลา PJ ประจำ BoxZa.com</div>
...
<tr>
<td style="text-align:center;"><?php $u=$this->user->profile($this->pj[$i]['u']);?><a href="http://boxza.com/<?php echo $u['link']?>" target="_blank"><?php echo _get_nick($u['cname']);?></a></td>
...
<tr>
<td style="text-align:center;"><?php $u=$this->user->profile($this->kick[$i]['u']);?><a href="http://boxza.com/<?php echo $u['link']?>" target="_blank"><?php echo _get_nick($u['cname']);?></a></td>
<td style="text-align:center; width:200px;"><?php echo time::show($this->kick[$i]['da'],'datetime')?></td>
</tr>
<?php endfor?>
</tbody>
</table>

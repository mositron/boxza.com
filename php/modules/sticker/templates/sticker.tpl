...
<meta property="og:site_name" content="สติกเกอร์">
...
<link rel="stylesheet" type="text/css" href="http://s0.boxza.com/static/css/sticker.css">
...
<div id="fb-root"></div>
<script>
window.fbAsyncInit = function() {FB.init({appId:'<?php echo _::$config['social']['facebook']['appid']?>', cookie:true, status:true, xfbml:true });};
(function() {
